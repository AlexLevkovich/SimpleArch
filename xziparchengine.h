#ifndef XZIPARCHENGINE_H
#define XZIPARCHENGINE_H

#include "complextararchengine.h"

class XzipArchEngine : public ComplexTarArchEngine {
    Q_OBJECT
public:
    Q_INVOKABLE XzipArchEngine(const QString & fileName,QObject *parent = 0,bool force_tobe_nottar = false);
